...
The UK government is consolidating its employment enforcement bodies into a single, more powerful entity: the **Fair Work Agency (FWA)**, established under the [Employment Rights Bill](https://www.gov.uk/government/collections/employment-rights-bill). Launching in **April 2026**, the FWA represents the biggest shake-up in employment compliance enforcement in a generation.
...
- **Civil penalties up to [£60,000 per illegal worker](https://www.gov.uk/government/publications/illegal-working-penalties)** — unchanged from current legislation, but enforcement will be significantly more proactive
