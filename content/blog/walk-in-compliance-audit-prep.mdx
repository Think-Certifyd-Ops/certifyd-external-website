...
The penalties for gaps are severe. **Up to [£60,000 in civil penalties](https://www.gov.uk/government/publications/illegal-working-penalties) per illegal worker.** Up to **5 years' imprisonment** for the most serious offences. And the FWA won't distinguish between a deliberate violation and an honest oversight. If the records aren't there, the liability is yours.
...
This is where many businesses are caught out — the same [temp worker loophole](/blog/temp-worker-loophole/) that leaves 1.1 million agency workers virtually unverified. You assume the agency conducted the checks. The agency assumes you know. Nobody has a complete picture.
