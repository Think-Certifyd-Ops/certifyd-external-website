...
This was not a proof-of-concept demonstration. It was an actual fraud, confirmed by Hong Kong police, and it represents the new reality of visual communication. We covered this incident in detail in [The $25 Million Deepfake](/blog/arup-deepfake-attack/). The people you see on your screen may not be real.
...
The barrier to entry has collapsed. Services advertising "interview stand-ins" — where a [deepfake impersonator takes a job interview](/blog/deepfake-candidates-recruitment/) on your behalf — are available for as little as **$50 per hour**. Open-source face-swap models are free to download. Voice cloning tools offer free tiers. A consumer-grade GPU can run the pipeline in real time.
...
[Learn how Certifyd's two-way verification protects every interaction where identity matters.](/products/codewords/)
