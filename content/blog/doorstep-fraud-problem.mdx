...
Those figures almost certainly understate the problem. [Age UK](https://www.ageuk.org.uk/information-advice/money-legal/scams-fraud/) estimates that only a fraction of doorstep crime is reported. Victims are often embarrassed, confused about what happened, or convinced that nothing will be done. Many don't realise they've been targeted until days or weeks later — if they realise at all.
...
The gas board scam has been [documented since the 1970s](https://www.tradingstandards.uk/consumers/support-and-advice/roguetraders/). It still works because the fundamental vulnerability hasn't changed: **there is no simple, reliable way to verify who is standing at your door**.
...
**Legitimate utility workers and tradespeople** benefit enormously. [Trade platforms currently can't verify who shows up](/blog/trade-platforms-blind-spot/) — verified identity changes that. They face hostility and suspicion at the door every day because of criminals who impersonate them. A verified identity that proves they are who they claim to be makes their job easier and safer.
...
The technology to fix this exists today. [Two-way identity verification](/products/codewords/) that works in 30 seconds, creates accountability, and doesn't require the victim to be their own security team.
