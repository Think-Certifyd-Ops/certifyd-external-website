...
export const SAFEGUARDING_PAGES: ForPage[] = [
     ...
     ───────────────────────────────────────────────────── */
  {
    ...
    searchIntentParagraph:
      "Protecting elderly parents from doorstep fraud requires verification that works when the vulnerable person cannot check for themselves. Certifyd uses bi-directional, device-verified authentication that can be managed by family members remotely. When someone arrives at an elderly person\u2019s home \u2014 a tradesperson, a care worker, a charity collector \u2014 the visitor verifies their identity through their registered device. The elderly person or their family member can confirm the visitor\u2019s identity and organisational affiliation in real time, creating an auditable record of every visit.",
    stats: [
    ...
    steps: [
      ...
      "Their identity and organisational membership are verified and confirmed through their device",
      "The elderly person (or their family member remotely) can see the visitor\u2019s verified identity and company",
      "A auditable record is created: who visited, when, and under whose authority",
    ],
    testimonial: {
      quote:
    ...
    faqs: [
      {
        ...
        answer:
          "Certifyd is designed so that the visitor does the verification, not the homeowner. The visitor opens the app and completes the verified credential challenge on their device. The elderly person (or their family member remotely) simply sees the verification result \u2014 a confirmed identity and organisational affiliation. For elderly parents who use a smartphone, they can view verification directly. For those who don\u2019t, family members can receive notifications and confirm visitors remotely.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Yes. Care workers can verify through Certifyd, confirming their identity and their active membership with the care provider. Family members receive a notification confirming who is caring for their parent. Over time, this builds a complete, auditable record of every care visit \u2014 who came, when, and under whose authority. This is particularly valuable when multiple carers rotate through the week.",
      },
    ],
    alsoRelevant: [
     ...
     ───────────────────────────────────────────────────── */
  {
    ...
    whyItMatters: [
      ...
      "Certifyd adds a preventive layer. Before a lone worker meets someone, both parties can verify through device-verified authentication. The lone worker knows who they\u2019re meeting, and the other person knows who the worker is. A record of the verified meeting is created automatically. If someone refuses to verify, the lone worker has grounds to refuse the meeting or escalate. This shifts lone worker safety from reactive (panic button after the fact) to preventive (identity verification before the meeting).",
    ],
    problems: [
    ...
    faqs: [
      {
        ...
        answer:
          "Certifyd adds identity verification to lone worker interactions. Before meeting an unfamiliar person, the lone worker can request Certifyd verification. Both parties prove their identity through their device-verified verified credentials. This creates a verified record of the meeting and gives the lone worker confidence about who they\u2019re meeting \u2014 or a clear warning signal if the other person can\u2019t verify.",
      },
      {
     ...
     ───────────────────────────────────────────────────── */
  {
    ...
    metaDescription:
      "Schools release children to adults they can\u2019t always verify. Certifyd confirms pickup authorisation verifiably \u2014 in 30 seconds.",
    badge: "School Pickups",
    headline: "A Stranger Says They\u2019re Picking Up Your Child. Are They?",
    subtitle:
      "School pickup authorisation relies on lists, passwords, and visual recognition. Certifyd verifies the collector\u2019s identity verifiably \u2014 confirming they are who the parent authorised.",
    ...
    searchIntentParagraph:
      "Identity verification for school pickups addresses a critical safeguarding gap: when someone other than the usual parent collects a child, the school must verify their identity and authorisation. Current systems \u2014 password words, phone calls to parents, checking ID cards \u2014 are imperfect and stressful. Certifyd uses device-verified authentication: the parent authorises a specific person, and that person verifies their identity through their registered device at pickup time. The school sees verified confirmation that the collector is who the parent said they would be.",
    stats: [
    ...
    whyItMatters: [
      ...
      "Certifyd provides verified certainty. The parent authorises a specific person through the app. At pickup, the authorised person verifies their identity through their device-verified verified credential. The school receives real-time confirmation that the collector\u2019s identity matches the parent\u2019s authorisation \u2014 not just a password, not just a phone call, but device-verified proof.",
    ],
    problems: [
    ...
    steps: [
      ...
      "The authorised person arrives at school and verifies through their device-verified verified credential",
      "The school receives verified confirmation: the collector\u2019s identity matches the parent\u2019s authorisation",
      "A auditable record is created: who collected, when, and under whose parental authority",
    ],
    faqs: [
      {
        question: "How does a parent authorise a pickup?",
        answer:
          "The parent designates an authorised collector through Certifyd, specifying the person\u2019s verified identity and the date or period of authorisation. The collector must already have a Certifyd identity (device-verified verified credential). At pickup time, the collector verifies at the school \u2014 the system confirms their identity matches the parent\u2019s authorisation. Authorisations can be one-time or ongoing, and can be revoked instantly.",
      },
      {
        question: "What if the authorised person doesn\u2019t have Certifyd?",
        answer:
          "The authorised person would need to register on Certifyd (a one-time process taking a few minutes). This is a feature, not a limitation: it means every authorised collector has a verified, device-verified identity. Anyone who can\u2019t or won\u2019t register cannot be verified verifiably, and the school should use alternative verification methods for that specific pickup.",
      },
      {
        question: "Does this replace the school\u2019s existing safeguarding procedures?",
        answer:
          "No. Certifyd adds a verification layer on top of existing safeguarding procedures. Schools should continue to maintain authorised collector lists, use their professional judgement, and follow DfE safeguarding guidance. Certifyd provides an additional, verified confirmation that the person collecting is who the parent authorised. It enhances existing procedures rather than replacing them.",
      },
      {
        question: "Can childminders and nannies use Certifyd for school pickups?",
        answer:
          "Yes. Childminders and nannies can register on Certifyd and be designated as authorised collectors by parents. At each pickup, they verify through their device-verified verified credential. The school sees their verified identity and the parental authorisation. This is particularly valuable for childminders who collect children from multiple families \u2014 each family\u2019s authorisation is managed independently.",
      },
    ],
    alsoRelevant: [
     ...
     ───────────────────────────────────────────────────── */
  {
    ...
    subtitle:
      "Safeguarding vulnerable people requires verifiable identity, not assumed identity. Certifyd provides verified identity of who is with whom, when, and under whose authority.",
    heroGraphic: "shift-monitor",
    heroCard: { name: "Dr. Sarah Khan", secondaryLabel: "Role", secondaryValue: "Safeguarding Lead" },
    searchIntentParagraph:
      "Safeguarding identity verification with Certifyd creates a verifiable chain of authority around vulnerable people. Every person who interacts with a vulnerable individual \u2014 care workers, visitors, volunteers, transport providers, professionals \u2014 verifies through device-verified authentication. The system confirms not just who they are, but their active membership with their organisation and their specific authorisation to be with that individual. When a safeguarding concern arises, there is an auditable record of exactly who was present, when, and under whose authority.",
    stats: [
    ...
    whyItMatters: [
      ...
      "Certifyd\u2019s bi-directional, device-verified authentication closes this gap. Every interaction creates an auditable record linked to a document-verified identity. When a safeguarding investigation asks \u2018who was with this person?\u2019, the answer is not \u2018we think it was...\u2019 but \u2018this specific, verified individual, confirmed through their registered device, working under this specific organisation\u2019s authority.\u2019",
    ],
    problems: [
    ...
    steps: [
      "Every person interacting with a vulnerable individual verifies through their device-verified verified credential",
      "The system confirms their identity, organisational membership, and specific authorisation",
      "A auditable record is created: who was present, when, where, and under whose authority",
