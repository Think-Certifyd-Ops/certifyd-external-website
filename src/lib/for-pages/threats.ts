...
export const THREAT_PAGES: ForPage[] = [
     ...
     ───────────────────────────────────────────────────── */
  {
    ...
    metaTitle: "Deepfake Protection \u2014 Device-Verified Identity",
    metaDescription:
      "Deepfakes can fool eyes and ears, but they can\u2019t fake a verified credential. Verify identity through device-verified authentication with Certifyd.",
    badge: "Deepfakes",
    headline: "You Can\u2019t Trust Your Eyes Anymore. Trust Verified Identity Instead.",
    subtitle:
      "Deepfake technology can synthesise faces and voices in real time. Certifyd defeats deepfakes by verifying identity through device-verified identity authentication \u2014 not through what you can see or hear.",
    heroGraphic: "qr-scan",
    heroCard: { name: "Sarah Mitchell", secondaryLabel: "Status", secondaryValue: "Verified via Certifyd" },
    searchIntentParagraph:
      "Deepfake protection with Certifyd works at the protocol level, not the perception level. Deepfake detection tools try to spot synthetic media \u2014 an arms race the detectors are losing. Certifyd takes a fundamentally different approach: instead of asking \u2018does this face look real?\u2019, it asks \u2018can this person complete a verified challenge on their registered device?\u2019 A deepfake can synthesise any face and any voice, but it cannot possess the physical device that holds someone\u2019s verified credential. Bi-directional, device-verified authentication makes deepfakes irrelevant to identity verification.",
    stats: [
    ...
    whyItMatters: [
      ...
      "Deepfake detection is an arms race that defenders are losing. Every detection algorithm trains the next generation of generators to evade it. Certifyd takes a fundamentally different approach: it doesn\u2019t try to detect fakes. Instead, it proves authenticity through device-verified identity authentication. A secure biometric authentication is bound to a physical device \u2014 it cannot be cloned, transferred, or generated by AI. When someone verifies through Certifyd, they prove they possess the physical device registered to that identity. No video, no voice, no visual assessment \u2014 just verified identity.",
    ],
    problems: [
    ...
    steps: [
      ...
      "Each person completes a verified challenge through their device-verified verified credential",
      "The system confirms both identities through WebAuthn authentication \u2014 unforgeable, unspoofable",
      "A auditable record is created: who verified, when, and through which registered device",
    ],
    testimonial: {
      quote:
    ...
    faqs: [
      {
        ...
        answer:
          "Certifyd doesn\u2019t try to detect deepfakes \u2014 it makes them irrelevant. Instead of analysing whether a face or voice is real (an arms race), Certifyd verifies identity through device-verified identity authentication. The person proves they possess the physical device registered to their identity by completing a verified credential challenge. A deepfake can generate any face or voice, but it cannot possess someone\u2019s physical phone. If the person can\u2019t complete the verified challenge, they are not who they claim to be.",
      },
      {
        question: "What is device-verified authentication?",
        answer:
          "Device-verified authentication means the person\u2019s identity is tied to a specific physical device through secure biometric authentication. Verification credentials are stored securely on the device and linked to the owner\u2019s biometrics. Authentication requires the physical device plus biometric or PIN unlock. This creates a chain of trust: the device proves the identity, and only the legitimate owner can unlock the device. No video, no voice, no screenshots \u2014 just hardware-backed verified identity.",
      },
      {
        question: "Can\u2019t someone steal the device?",
        answer:
          "Possessing the device alone is not enough. The verified credential requires the device owner\u2019s biometric authentication (fingerprint, face ID) or PIN to complete the verified challenge. A stolen device without the owner\u2019s biometric is useless for verification. Additionally, devices can be remotely wiped and identities can be revoked through Certifyd\u2019s Organisation management. The security model is: something you have (the device) plus something you are (biometric) or something you know (PIN).",
      },
      {
        question: "Is this relevant for my business?",
        answer:
          "If your business conducts video calls, processes applications remotely, makes financial decisions based on verbal instructions, or employs people you haven\u2019t met in person \u2014 yes. Deepfake technology is democratising impersonation. The Arup attack cost \u00a320 million from a single video call. AI-generated candidates are appearing in recruitment pipelines. CEO fraud via voice cloning is targeting businesses of all sizes. Device-verified authentication provides a verification method that deepfakes cannot defeat.",
      },
    ],
    alsoRelevant: [
     ...
     ───────────────────────────────────────────────────── */
  {
    ...
    searchIntentParagraph:
      "CEO fraud protection with Certifyd replaces trust in voices, emails, and video calls with verified verification. Traditional CEO fraud relies on impersonating a senior executive \u2014 via email, phone, or increasingly via deepfake video. Certifyd defeats this by requiring device-verified authentication: before acting on any high-stakes instruction, the recipient can request that the supposed sender verify their identity through their registered device. A deepfake can clone a CEO\u2019s voice and face, but it cannot complete a verified credential challenge on the CEO\u2019s phone.",
    stats: [
    ...
    whyItMatters: [
      ...
      "Training and awareness help, but they fail against high-quality impersonation. Certifyd provides a protocol-level solution: any employee receiving a high-stakes instruction can request the sender to verify through Certifyd. The sender must complete a verified credential challenge on their registered device. If they can\u2019t \u2014 because they\u2019re not the real person \u2014 the instruction is flagged immediately. This makes CEO fraud structurally impossible, not just unlikely.",
    ],
    problems: [
    ...
    steps: [
      ...
      "Employee requests the sender to verify through Certifyd \u2014 a 30-second device-verified authentication",
      "If the sender is genuine, they complete the verified credential challenge on their registered device",
    ...
    faqs: [
      {
        ...
        answer:
          "Certifyd creates a verification step for high-stakes instructions. When an employee receives an unusual request from a supposed executive, they can ask the sender to verify through Certifyd. The sender must complete a verified challenge on their registered device \u2014 something only the real executive possesses. A deepfake or impersonator cannot complete this challenge. The verification takes 30 seconds and creates an auditable record.",
      },
      {
     ...
     ───────────────────────────────────────────────────── */
  {
    ...
    metaTitle: "Voice Cloning Protection \u2014 Device-Verified Identity",
    metaDescription:
      "Voice cloning can replicate anyone\u2019s voice from seconds of audio. Verify identity through verified identity, not through what you hear.",
    badge: "Voice Cloning",
    headline: "That\u2019s Their Voice. But It\u2019s Not Them.",
    subtitle:
      "Voice cloning technology can replicate a person\u2019s voice from a few seconds of audio. Certifyd verifies identity through verified identity that voices cannot fake.",
    heroGraphic: "qr-scan",
    heroCard: { name: "James Richardson", secondaryLabel: "Role", secondaryValue: "Board Member" },
    searchIntentParagraph:
      "Voice cloning protection with Certifyd eliminates the voice channel as a trusted identity signal. AI voice cloning can now replicate any person\u2019s voice from a few seconds of recorded audio \u2014 enough to fool colleagues, family members, and bank voice-recognition systems. Certifyd replaces voice-based trust with device-verified identity authentication. When identity matters, the person verifies through their registered device, not through their voice. A cloned voice cannot complete a verified credential challenge.",
    stats: [
    ...
    steps: [
      ...
      "The caller must complete a device-verified verified credential challenge on their registered phone",
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Certifyd doesn\u2019t replace phone calls \u2014 it adds a verification step alongside them. When a call\u2019s authenticity matters, the recipient can ask the caller to verify through Certifyd (a quick verified credential authentication on their phone). This can happen during the call or immediately after. The verification record confirms the caller\u2019s identity verifiably, regardless of what their voice sounded like.",
      },
    ],
    alsoRelevant: [
      { label: "Certifyd for Deepfakes", slug: "deepfakes" },
     ...
     ───────────────────────────────────────────────────── */
  {
    ...
    metaDescription:
      "Phishing attacks impersonate trusted people and organisations. Verify the sender\u2019s identity verifiably \u2014 in 30 seconds with Certifyd.",
    badge: "Phishing",
    ...
    steps: [
      ...
      "The sender completes a device-verified verified credential challenge on their registered phone",
    ...
    faqs: [
      {
        ...
        answer:
          "Email security tools analyse emails for known phishing patterns \u2014 suspicious links, domain spoofing, attachment types. They\u2019re valuable but reactive: they catch attacks that match known patterns. Certifyd adds sender identity verification: instead of analysing the email, it verifies the person who claims to have sent it. The sender must complete a verified challenge on their registered device. This is proactive and defeats novel attacks that email filters haven\u2019t seen before.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Voice phishing (vishing) is increasingly common, especially with voice cloning technology. Certifyd works across all channels: if someone calls claiming to be from IT, HR, or your bank, you can ask them to verify through Certifyd. The verification is device-verified, not channel-bound, so it works whether the impersonation attempt comes via email, phone, video call, or text message.",
      },
      {
     ...
     ───────────────────────────────────────────────────── */
  {
    ...
    metaDescription:
      "Romance scams cost UK victims \u00a331M+ annually. Verify that the person you\u2019re talking to is real \u2014 verifiably, not just visually.",
    badge: "Romance Scams",
    ...
    steps: [
      ...
      "Both of you open Certifyd and complete a device-verified verified credential authentication",
    ...
    faqs: [
      {
        ...
        answer:
          "Certifyd provides a way to verify that the person you\u2019re talking to online is real. By requesting mutual Certifyd verification early in an online relationship, you can confirm that the other person has a device-verified, verified identity. A scammer using stolen photos, AI-generated personas, or deepfake video cannot complete this verification because they don\u2019t have a registered device linked to the identity they\u2019re claiming.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Certifyd doesn\u2019t analyse photos or voices to detect AI generation \u2014 that\u2019s an arms race. Instead, it requires the person to prove their identity through a physical device. An AI-generated persona doesn\u2019t have a physical device with a registered verified credential. The verification either succeeds (real person, verified device) or it doesn\u2019t. No grey areas, no analysis, no guesswork.",
      },
      {
        question: "What about dating apps \u2014 could they integrate Certifyd?",
        answer:
          "Yes. Dating platforms could offer Certifyd verification as a trust signal on profiles. A verified badge backed by device-verified identity authentication is fundamentally more trustworthy than photo verification (which deepfakes can defeat) or social media linking (which fake accounts can imitate). For platforms serious about user safety, Certifyd provides the strongest possible identity assurance.",
      },
    ],
    alsoRelevant: [
     ...
     ───────────────────────────────────────────────────── */
  {
    ...
    metaDescription:
      "Social engineering exploits trust in people, not flaws in technology. Verify the person behind the request with device-verified authentication.",
    ...
    searchIntentParagraph:
      "Social engineering protection with Certifyd addresses the fundamental vulnerability in all social engineering attacks: unverified identity. Whether the attacker impersonates a colleague, a vendor, IT support, or a bank official, the attack depends on the target trusting the attacker\u2019s claimed identity. Certifyd provides a universal verification step: before acting on any request, the target can ask the requester to verify through device-verified identity authentication. This transforms social engineering from a human judgement problem into a protocol problem \u2014 and protocols don\u2019t get fooled.",
    stats: [
    ...
    steps: [
      ...
      "Employee asks the requester to verify through Certifyd \u2014 a 30-second device-verified authentication",
      "The requester must complete a verified credential challenge on their registered device",
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Social engineering works because the attacker controls the narrative: they choose who to impersonate, what to request, and how to create urgency. Certifyd shifts control to the target. By requesting device-verified verification, the target introduces a step the attacker cannot fake. The attacker\u2019s narrative, persuasion skills, and AI tools become irrelevant \u2014 they either have the real person\u2019s device or they don\u2019t. It turns social engineering from a human judgement problem into a binary verification outcome.",
      },
      {
        question: "What about physical social engineering (tailgating, impersonation)?",
        answer:
          "Certifyd works for in-person social engineering too. If someone claims to be a vendor, IT engineer, or auditor and requests physical access, the site manager can ask them to verify through Certifyd. The person must prove their identity and organisational membership through their device-verified verified credential. Someone who tailgated through a secure entrance or is impersonating a vendor cannot complete this verification.",
      },
      {
        question: "Can Certifyd protect against supply chain social engineering?",
        answer:
          "Yes. Supply chain attacks often involve impersonating a vendor to gain access or redirect payments. If a \u2018vendor\u2019 contacts you requesting a change to payment details or access credentials, requesting Certifyd verification confirms whether they are genuinely from the vendor organisation. Their device-verified identity is linked to their active organisational membership \u2014 an impersonator from outside the organisation cannot complete the verification.",
      },
    ],
    alsoRelevant: [
      { label: "Certifyd for Phishing", slug: "phishing" },
