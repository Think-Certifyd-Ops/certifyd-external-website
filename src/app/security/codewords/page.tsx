...
const controls = [
  ...
  },
  {
    ...
    body: "The presenting phone changes frames about every 650 milliseconds. The scanner requires three fresh, sequential frames and rejects an expired session.",
  },
  {
    title: "A second nearby-device signal",
    body: "The QR session carries a random Bluetooth service identifier. The scanning phone looks for that advertised service while both people compare the same words and number.",
  },
  {
    ...
    <>
      <section className="relative bg-navy pt-32 pb-20 lg:pt-40 lg:pb-28">
        <div className="section-container">
          ...
          <p className="mt-6 text-sm text-text-on-dark-muted">Protocol summary updated 10 August 2026 • Current beta assurance</p>
        </div>
      </section>
      ...
      <section className="section-dark">
        <div className="section-container">
          ...
          <div className="mt-8 rounded-sm border border-certifyd-blue/35 bg-certifyd-blue/10 p-8">
            <h2 className="font-heading text-2xl font-bold text-text-on-dark">Current Bluetooth limitation</h2>
            <p className="mt-4 max-w-4xl leading-relaxed text-text-on-dark-muted">
              The beta uses Bluetooth advertisement and discovery as a second nearby-device signal. It is not an encrypted phone-to-phone Bluetooth challenge and does not prove distance. A modified app or coordinated relay can still attack the ceremony. The comparison words and number let both people detect a mismatched session before accepting.
            </p>
          </div>
        </div>
      </section>
